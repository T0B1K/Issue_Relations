...
exports.writeToFile = exports.getDataFromFile = exports.DataNode = exports.Relation = void 0;
var URL = require('url');
var fs_1 = require("fs");
var Relation;
(function (Relation) {
    Relation[Relation["right"] = 0] = "right";
    Relation[Relation["left"] = 1] = "left";
    Relation[Relation["both"] = 2] = "both";
    Relation[Relation["duplicate"] = 3] = "duplicate";
...
function writeToFile(content, filename) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                fs_1.promises.writeFile(filename, content, { flag: 'w+' });
            }
            catch (err) {
                console.error(err);
            }
